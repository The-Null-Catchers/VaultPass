...
| Credential stuffing/brute force | Expensive derivation, proof hash, Redis limits | Account MFA and distributed account-targeted throttling need additional hardening |
